...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "birthDate":"2020-01-01T00:00:00.000Z", "address":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "notes":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "mobile":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
